...
class Tabla_comp{
    ...
    public function tablaCard(){
        ...
        echo                '<img src="./img/1.jpg" class="card-img-top" alt="...">';
        ...
        echo                        '<a href="./borrar.php?id='.$fila["id_productos"] .'" class="card-link"> Borrar <i class="fas fa-trash-alt"></i></a>';
                                ...
                                echo '<a href="./carrito_us/carrito_us.php?id='.$fila["id_productos"] .'" class="card-link"> Borrar <i class="fas fa-trash-alt"></i></a>';
                            }
                        }
        echo                    '</div>';
        echo                '</div>';
